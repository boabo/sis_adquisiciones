...
BEGIN
    ...
    */
          ...
          END IF;
            ...
            v_requiere_contrato,
            COALESCE((p_hstore_cotizacion->'v_fecha_cotiz')::date,null),
            COALESCE((p_hstore_cotizacion->'v_fecha_ini')::date,null),
            COALESCE((p_hstore_cotizacion->'v_fecha_venc')::date,null),
            COALESCE((p_hstore_cotizacion->'v_forma_pago')::varchar,'')
