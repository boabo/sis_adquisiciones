...
DECLARE
    ...
    v_id_periodo integer;
     ...
     v_dec_proveedor text;
      ...
      -- variables para crear alarma hacia el solicitante.
...
BEGIN
	...
	***********************************/
		...
		begin
            ...
            --actualizamos el nro de cuotas de la solicitud
            ...
            v_id_alarma :=  param.f_inserta_alarma(
                                                  ...
                                                  '../../../sis_adquisiciones/vista/cotizacion/CotizacionAdq.php',--acceso directo
                                                  now()::date,
                                                  'notificacion',
                                                  '',   -->
                                                  p_id_usuario,
                                                  ...
                                                  '{filtro_directo:{campo:"id_cotizacion",valor:"'||v_registros_cotizacion.id_cotizacion::varchar||'"}}',
                                                  NULL::integer,
                                                  'Se habilito pago al tramite #'||v_registros_sol.num_tramite
                                                  );
