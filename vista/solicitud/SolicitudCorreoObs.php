...
<script>
    Phx.vista.SolicitudCorreoObs=Ext.extend(Phx.frmInterfaz,{
        ActSave:'../../sis_adquisiciones/control/Solicitud/SolicitarCierreObs',

        constructor:function(config){
            
            this.maestro = config;
            Phx.vista.SolicitudCorreoObs.superclass.constructor.call(this,config);
            this.init();
        ...
        loadValoresIniciales:function()
        {
            ...
            CuerpoCorreo+='<b>Numero: </b>'+this.numero+'</BR> Deseandole mucho exito en sus actividades , solicito encarecidamente cerrar su Observación y dar seguimiento a este Tramite. <br>';
            CuerpoCorreo+='<br>Resuelto por: <br> '+Phx.CP.config_ini.nombre_usuario+'<br>';


            Phx.vista.SolicitudCorreoObs.superclass.loadValoresIniciales.call(this);
